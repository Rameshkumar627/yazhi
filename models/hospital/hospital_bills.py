...
# Bills
class HospitalBills(surya.Sarpam):
    _name = "hospital.bill"

    date = fields.Date(srring="Date")
    vendor_id = fields.Many2one(comodel_name="res.partner", string="Vendor")
    bill_detail = fields.One2many(comodel_name="hospital.bill.detail",
...
class HospitalBillsDetail(surya.Sarpam):
    _name = "hospital.bill.detail"
